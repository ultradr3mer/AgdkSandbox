...
namespace ndk_helper {
	...
	public:
		 ...
		 */
		static JNIHelper* GetInstance() { static JNIHelper* s_instance = new JNIHelper(); return s_instance; }
		 ...
		 */
		int32_t GetNativeAudioBufferSize() { return 0; }
		 ...
		 * audio
		 */
		int32_t GetNativeAudioSampleRate() { return 0; }
		 ...
		 *
		 */
		const char* GetAppLabel() const { return ""; }
	};
#else
class JUIView;

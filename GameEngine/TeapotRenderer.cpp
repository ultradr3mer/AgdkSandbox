...
void TeapotRenderer::Render(float diffuse_color[3]) {
	//
	...
	TEAPOT_MATERIALS material = {
		{diffuse_color[0], diffuse_color[1], diffuse_color[2]}, {1.0f, 1.0f, 1.0f, 10.f}, {0.1f, 0.1f, 0.1f}, };
	...
	glUniform3f(shader_param_.light0_, 10.f, -20.f, -60.f);
